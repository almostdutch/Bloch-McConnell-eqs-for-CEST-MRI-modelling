function varargout=cest_sim_slave_ss_fast(spacing, pools, offset_w, pulse_method, cwpe_approximation, sampling, fs, B1amp, pulse_dur, pulse_int, spoiler,pulse_repeat, dummy, recovery, pulse_sampling_factor,readout_par,other_par)
...
pulse_cest_int(1,2)=pulse_int+spoiler;
%% readout
...
pulse_postreadout_dead_time(1,2)=after_TR_dead_time;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
