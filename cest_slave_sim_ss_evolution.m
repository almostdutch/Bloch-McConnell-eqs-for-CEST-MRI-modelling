function [freq_offsets, spectrum, offset_order, time_evolution, spectrum_evolution] = cest_slave_sim_ss_evolution(spacing_for_mz, pools, freq_offsets, sampling_strategy, main_field_strength, ...
...
%% interval + spoiler
pulse_cest_int(1:N_points_int+N_points_spoiler,1)=0;
pulse_cest_int(1:N_points_int+N_points_spoiler,2)=sampling_rate_mt;
%% readout
...
pulse_postreadout_dead_time(1:N_ponts_dead_time,1)=0;
pulse_postreadout_dead_time(1:N_ponts_dead_time,2)=sampling_rate_mt;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
spectrum_evolution=zeros(length(ww),(size(pulse_cest_mt,1)+size(pulse_cest_int,1)+size(pulse_readout,1)*N_ex+size(pulse_postreadout_dead_time,1))*N_seq_repeatitions+1);
time_evolution=zeros(length(ww),(size(pulse_cest_mt,1)+size(pulse_cest_int,1)+size(pulse_readout,1)*N_ex+size(pulse_postreadout_dead_time,1))*N_seq_repeatitions+1); 
